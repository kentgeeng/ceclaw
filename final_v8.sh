#!/bin/bash
# CeLaw Agent v6 全功能迴圈驗證 (v8 - 最終嚴格版)
# 修復：Resume 改用 exit code + 檔案非空 驗證

AGENT="$HOME/ceclaw/claw-agent-v6.py"
LOG_DIR="$HOME/ceclaw/test_logs/v8_final"
REPORT_DIR="$HOME/ceclaw/test_reports"
mkdir -p "$LOG_DIR" "$REPORT_DIR"

REPORT="$REPORT_DIR/report_v8_$(date +%Y%m%d_%H%M%S).txt"

echo "=========================================================="
echo "  CeLaw Agent v6 全功能迴圈驗證 (v8 - 最終版)"
