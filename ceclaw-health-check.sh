...
# sandbox 狀態
SANDBOX_STATUS=$(openshell sandbox list 2>/dev/null | grep "ceclaw-agent" | awk '{print $4}')
...
UFW_ROUTED=$(sudo ufw status verbose 2>/dev/null | grep "Default:" | grep routed | awk '{print $3}')
