  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'hermes-control',
        name: 'HermesControl',
        component: () => import('@/views/hermes-control/HermesControlPage.vue'),
        meta: { titleKey: 'routes.hermesControl', icon: 'TerminalOutline' },
      },
      {
        path: 'knowledge',
        name: 'Knowledge',
        component: () => import('@/views/knowledge/KnowledgePage.vue'),
        meta: { titleKey: 'routes.knowledge', icon: 'BookOutline' },
      },
      {
        path: 'settings',
        name: 'Settings',
